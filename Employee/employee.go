...
func main() {
	...
	company.AddEmployee("3", FullTimeEmployee{ID: 3, Name: "Liana", Salary: 100000})                        // Использую уникальный ID
	company.AddEmployee("4", PartTimeEmployee{ID: 4, Name: "Askat", HourlyRate: 105000, HoursWorked: 18.5}) // Уникальный ID
